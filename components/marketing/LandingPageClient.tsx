      ...
      <main className="relative z-10">
            ...
            <div className="relative mx-auto max-w-4xl text-center">
              ...
              >
                ...
                >
                  ...
                  View on GitHub
                  <span className="ml-2 text-[hsl(var(--color-text-secondary))]">
                    ↗
                  </span>
                </MagneticButton>
              </div>
        ...
        <section id="features" className="py-32">
          <div className="mx-auto w-full max-w-7xl px-4">
            <RevealOnScroll className="mb-12 text-center">
              <h2 className="text-[clamp(2rem,5vw,3.8rem)] leading-tight">
                Everything you need to ship confidently
              </h2>
              <p className="mx-auto mt-4 max-w-2xl text-[hsl(var(--color-text-secondary))]">
                Built for founders and developers who care about velocity and
                code quality.
              </p>
            </RevealOnScroll>
            ...
            <div className="grid auto-rows-[170px] grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
              ...
              >
                <div className="mt-2 flex flex-wrap items-center gap-3 text-sm text-[hsl(var(--color-text-secondary))]">
                  {["Starter", "Pro", "Business"].map((tier) => (
                    <span
                      key={tier}
                      className="inline-flex items-center gap-2 rounded-full border border-[hsl(var(--color-border))] px-3 py-1"
                    >
              ...
              >
                <p className="text-sm text-[hsl(var(--color-text-secondary))]">
                  Login, signup, OAuth, and session handling out of the box.
                </p>
              </FeatureTile>
              ...
              >
                <p className="text-sm text-[hsl(var(--color-text-secondary))]">
                  Safe multi-tenant defaults with strongly scoped policies.
                </p>
              </FeatureTile>
        ...
        <section className="py-32">
          <div className="mx-auto grid w-full max-w-7xl gap-8 px-4 lg:grid-cols-2 lg:items-center">
            <RevealOnScroll>
              <p className="mb-2 text-sm text-[hsl(var(--color-accent-soft))]">
                AI integration in 10 lines
              </p>
              <h3 className="text-[clamp(1.8rem,4vw,3rem)] leading-tight">
                No boilerplate. No gotchas. Just ship.
              </h3>
          ...
          <div className="mx-auto w-full max-w-7xl px-4">
            <div className="glass grid gap-6 rounded-2xl border border-[hsl(var(--color-border))] px-6 py-8 md:grid-cols-4">
              {[
                ...
                {
                  value: 0,
                  label: "of unnecessary boilerplate",
                  suffix: " lines",
                  format: "number" as const,
                },
                {
                ...
                <div key={stat.label} className="relative text-center">
                  {index > 0 ? (
                    <span className="pointer-events-none absolute left-0 top-1/2 hidden h-12 w-px -translate-y-1/2 bg-[hsl(var(--color-accent)/0.35)] md:block" />
                  ) : null}
                  <p className="text-4xl text-[hsl(var(--color-text-primary))]">
                    <AnimatedNumber value={stat.value} format={stat.format} />
                    {stat.suffix}
                  </p>
                  <p className="mt-2 text-xs uppercase tracking-[0.1em] text-[hsl(var(--color-text-secondary))]">
                    {stat.label}
                  </p>
                </div>
              ))}
        ...
        <section className="py-32">
          <div className="mx-auto w-full max-w-7xl px-4">
            <RevealOnScroll className="text-center">
              <h3 className="text-[clamp(2rem,5vw,3.4rem)]">
                ...
                <RevealOnScroll key={plan.key}>
                  <motion.div
                    ...
                    className={cn(
                      ...
                      plan.key === "pro"
                        ? "shadow-[0_0_60px_-15px_hsl(var(--color-accent)/0.45)]"
                        : "",
                    )}
                  >
                    {plan.key === "pro" ? (
                    ...
                    <p className="mt-3 text-5xl leading-none text-[hsl(var(--color-text-primary))]">
                      ${plan.price}
                      <span className="ml-1 text-sm text-[hsl(var(--color-text-secondary))]">
                        /month
                      </span>
                    </p>
            ...
            <div className="mt-8 text-center">
              <Link
                href="/pricing"
                className="text-sm text-[hsl(var(--color-accent-soft))] hover:text-[hsl(var(--color-text-primary))]"
              >
                View full pricing
              </Link>
            </div>
        ...
        <section className="py-32">
          <div className="mx-auto w-full max-w-7xl px-4">
            <RevealOnScroll className="text-center">
              <h3 className="text-[clamp(1.9rem,4.6vw,3.2rem)]">
              ...
              <div className="inline-flex items-center gap-3 rounded-full border border-[hsl(var(--color-border))] bg-[hsl(var(--color-bg-elevated)/0.75)] px-4 py-2 text-sm text-[hsl(var(--color-text-secondary))]">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((id) => (
                    <span
                      key={id}
                      className="inline-block size-7 rounded-full border border-[hsl(var(--color-bg))] bg-[hsl(var(--color-surface))]"
                    />
                  ))}
                </div>
    ...
    <RevealOnScroll className={className}>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h3 className="mb-3 text-xl text-[hsl(var(--color-text-primary))]">
            {title}
          </h3>
          {children}
        </div>
...
function CodePanel({ codeLines }: { codeLines: string[] }) {
  ...
  return (
    <div
      ref={ref}
      className="mt-6 overflow-hidden rounded-2xl border border-[hsl(var(--color-border))] bg-[hsl(var(--color-bg-elevated))] shadow-[inset_0_1px_0_hsl(var(--color-text-primary)/0.05)]"
    >
      <div className="flex items-center justify-between border-b border-[hsl(var(--color-border))] px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-3 text-xs text-[hsl(var(--color-text-secondary))]">
...
function ChatMediaFallback() {
  ...
  if (videoFailed) {
    return (
      <Image
        src="/marketing-chat-placeholder.png"
  ...
  return (
    <video
      ...
      poster="/marketing-chat-placeholder.png"
    />
  );
}
